...
define("mysql_host", default="dev.cisege0e6wes.us-west-2.rds.amazonaws.com:3306", help="blog database host")
define("mysql_database", default="seerpod", help="blog database name")
define("mysql_user", default="root", help="blog database user")
define("mysql_password", default="5eerp0d1nc", help="blog database password")
